    ...
    >
      <View style={{ flexDirection: "row" }}>
        ...
        <View style={{ marginLeft: 10, width: '55%' }}>
          ...
          <Text style={styles.cardDescription}>Sale: {sale}</Text>
        </View>
      ...
      {isOpen && (
        <View style={{ marginTop: 10, borderTopWidth: 0.5, borderColor: Colors.lightBlue }}>
          ...
          <View style={styles.detailRow}>
            <Text style={styles.detailLeftText}>Sale</Text>
            <Text style={styles.detailRightText}>{sale}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLeftText}>Revenue</Text>
            <Text style={styles.detailRightText}>{CurrencySign} {revenue}</Text>
          </View>
