...
const TeacherBasicInfoDisplay: React.FC<TeacherBasicInfoDisplayProps> = ({ teacher, onSave }) => {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.main}>
        ...
        <View style={styles.card}>
          ...
          {/* Read-only Sections */}
          <Text style={styles.sectionHeader}>Assigned Classes</Text>
          <View style={styles.row}>
            <Text style={styles.label}>Classes</Text>
            <Text style={styles.value}>
              {editedTeacher.assignedClasses?.map(c => c.className).join(', ') || 'None'}
            </Text>
          </View>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>
              {editedTeacher.subjects?.map(s => s.name).join(', ') || 'None'}
            </Text>
          </View>
...
export default TeacherBasicInfoDisplay;