...
import { fetchBusnessVendorMicroFinance } from "../../redux/slices/authSlice";
...
const MicroFinanceTab = () => {
  ...
  const { businessVendorMicroFinancers, loading, error } = useSelector(
  ...
  useEffect(() => {
      ...
      dispatch(fetchBusnessVendorMicroFinance());
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <HeadingText text="Micro Financers List" textStyle={{fontSize:16}}/> */}
      
       <FlatList
         data={businessVendorMicroFinancers}
